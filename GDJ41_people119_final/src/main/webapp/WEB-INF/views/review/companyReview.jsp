			...
			<div class="layout">
				<div class="inner">
					<div class="company_info">
						<div class="logo">
							<img alt="사진드러갈거야" src="/resources/upload/company/${company.companyImage }">
							<p>사진옆에 총합 별점</p>
						</div>
						<div class="title">
						...
						<div class="subTitle">
							<span><c:out value="${company.service }"/></span>
							<span>
								<c:choose>
							...
							<span>직원수<c:out value="${company.employeeNumber }"/>명</span>
							<span><c:out value="${company.ceoName }"/></span>
						</div>
						<div class="best">
							<span>1번</span>
							<span>2번</span>
					...
					<div class="review_box">
						<div class="review_content">
							...
							<div class="wrap_card">
								<div class="card">
									<strong class="title">Q<span>회의는 얼마나 자주하나요?</span></strong>
									<div class="progress">
								...
								<div class="card">
									<strong class="title">Q<span>회식주기는 어떤가요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>회식은 어떻게 진행되나요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>출근시간이 자유로운 편인가요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>회사 직원의 평균 연령대는 어떤가요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>출근 복장은 어떤가요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>야근은 많이 하시나요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>성과금은 얼마나 지급되나요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>육아휴직은 자유롭게 사용하시나요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>일을 하면서 스스로 성장하고 있나요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>나의 커리어에 도움이 될까요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>직원을 위해 자기개발비를 지원해주나요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>회사에 본받을 사람이 있나요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>직원들의 평균 근속 연수는 얼마나 되나요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
								...
								<div class="card">
									<strong class="title">Q<span>경영진의 리더십 스타일은 어떤가요?</span></strong>
									<div class="progress">
									  	<div class="progress-bar" role="progressbar" aria-valuenow="70"
